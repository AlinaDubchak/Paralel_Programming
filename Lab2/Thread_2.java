...
public class Thread_2 extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            // сигнал про завершення обчислення а = а + а2
            data.S2.release(3);      // семафор S2

            data.S1.acquire();              // очікування на завершення обчислень а з Т1, Т3, Т4
            ...
            int[] Xh = Data.calculateXh(Ch, Zh, ai, di);             //Обчислення Хн = а2 * d1 * Zн + а2*Сн
